...
BEGIN
-- IF THERE IS NO DATA IN ANY OF THE TABLES, INSERT DATA
    IF (SELECT COUNT(*) FROM Pacientes) = 0 AND (SELECT COUNT(*) FROM Doctores) = 0 AND (SELECT COUNT(*) FROM Turnos_Fechas) = 0 AND (SELECT COUNT(*) FROM Turnos_Pacientes) = 0 THEN
